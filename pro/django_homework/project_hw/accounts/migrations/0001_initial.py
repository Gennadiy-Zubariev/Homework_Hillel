    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=255, unique=True, verbose_name='Електронна адреса')),
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_pict/')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Персонал')),
                ('is_active', models.BooleanField(default=True, verbose_name='Активний')),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата реєстрації')),
                ('preffered_language', models.CharField(choices=[('uk', 'Ukrainian'), ('en', 'English')], default='uk', max_length=10, verbose_name='Мова')),
