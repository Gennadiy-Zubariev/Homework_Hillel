...
# номінали: 5, 10, 20, 50, 100, 200 та 500 евро. А монети: 2 та 2 євро,
# 2, 2, 5, 10, 20 та 50 євроцентів.
...
#
# l_nom =[500, 200, 100, 50, 20, 10, 5, 2, 2, 0.5, 0.2, 0.2, 0.05, 0.02, 0.01]
...
# mon = {k: v for k, v in d.items() if k in [2, 2, 0.5, 0.2, 0.2, 0.05, 0.02, 0.01] and v > 0}
